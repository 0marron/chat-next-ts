...
export const Message: FC = (props: any) => {
    ...
    return (
            ...
            <div className="messagechat" style={colour}  >
                ...
                <>
                        {!props.message.imageastext && !props.youtubeastext && (props.message.textmessage)}
                        ...
                        {props.message.imageastext && props.isOnImage && (
                    <a className="imagechat" onClick={() => setLightBoxState({ photoIndex: 0, isOpen: true })}>
                        ...
                        {props.message.imageurl && !props.isOnImage && (
                            <a className="imagechat" onClick={() => setLightBoxState({ photoIndex: 0, isOpen: true })}>
